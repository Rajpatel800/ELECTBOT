  ...
  usa: [
    {
      ...
      content: `## Who Can Register?\n- A U.S. citizen aged **18 or older** on or before Election Day.\n- A resident of the state where you're registering.\n- Meeting state-specific requirements (e.g., felony conviction laws vary by state).\n\n## Step-by-Step Registration\n1. Visit **[vote.gov](https://vote.gov)** — the official federal portal.\n2. Select your state to be directed to your local election office.\n3. Provide: Full legal name · Address · Date of birth · State ID or last 4 digits of SSN.\n4. **Deadline:** Most states require registration **15–30 days** before Election Day.\n5. Receive your **Voter Registration Card** by mail in 2–4 weeks.\n\n💡 *Also available via mail-in forms or in person at DMVs and post offices.*\n🌐 *Same-Day Registration is available in 20+ states!*`,
    },
    {
      id: "us2", icon: "🏛️", title: "Federal, State & Local Elections", tag: "Intermediate · 6 min",
      content: `## 1. Presidential Elections (Every 4 Years)\nCitizens vote for a **slate of Electors** (the Electoral College), not the President directly. A candidate needs 270 electoral votes to win.\n\n## 2. Midterm Elections (Every 2 Years)\nHeld halfway through a President's term. All **435 House seats**, about 33 Senate seats, and 36 Governorships are on the ballot. These elections heavily impact federal policy.\n\n## 3. State Elections\nElecting Governors, State Senators, and State Representatives. State governments control education, transportation, and local laws.\n\n## 4. Local Elections\nElecting Mayors, City Councils, Sheriffs, Judges, and School Board members. Despite affecting daily life most directly, voter turnout is often **under 15%**.\n\n## 5. Primary Elections\nVoters decide which candidates will represent their political party in the general election.`,
    },
    {
      id: "us3", icon: "📍", title: "Election Day: Complete Guide", tag: "Intermediate · 7 min",
      content: `## Valid ID Documents\nVoter ID laws vary drastically by state. Roughly 35 states require some form of ID. Acceptable forms usually include: State Driver's License · U.S. Passport · Military ID.\n\n## Three Ways to Vote\n1. **In-Person on Election Day:** Vote at your assigned polling place, usually open from early morning to 7 or 8 PM.\n2. **Early Voting:** Vote in person 1–4 weeks before Election Day (available in 47 states).\n3. **Mail-In / Absentee Voting:** Request a ballot by mail, fill it out at home, and return it via mail or a secure drop box.\n\n## Step-by-Step at the Polling Place\n1. **Find your location:** [vote.gov/find-my-polling-place](https://vote.gov/find-my-polling-place)\n2. **Check-in:** Poll workers verify your name and ID (if required).\n3. **Cast Vote:** Use a voting machine or mark a paper ballot in a **private booth**.\n\n⏰ Poll hours vary by state.\n💡 **Pro tip:** If you're in the queue before polls close, you **must** be allowed to vote by law.`,
    },
    {
      id: "us4", icon: "⚖️", title: "The Electoral College Explained", tag: "Advanced · 8 min",
      content: `## The Core Mechanic\nThe U.S. President is not elected by a national popular vote. Instead, they are elected by the **Electoral College**, which consists of **538 total Electors**.\n\n## The Magic Number\nA candidate needs an absolute majority of **270 electoral votes** to win the presidency.\n\n## How Allocations Work\nEach state is allocated electoral votes equal to its total congressional delegation: **House Representatives (based on population) + 2 Senators**.\n\n## Winner-Takes-All System\nIn 48 states and Washington D.C., the candidate who wins the state's popular vote gets **all** of that state's electoral votes. Only **Maine** and **Nebraska** use a proportional system to split their votes.\n\n## Swing States\nBecause of the winner-takes-all system, candidates often focus their campaigns on a handful of highly competitive "battleground" or "swing" states.`,
    },
    {
      id: "us5", icon: "📜", title: "Your Fundamental Voter Rights", tag: "Essential · 5 min",
      content: `## Constitutional Foundation\n- **15th Amendment (1870):** Prohibits denying the right to vote based on race or color.\n- **19th Amendment (1920):** Grants women the right to vote.\n- **24th Amendment (1964):** Abolished poll taxes in federal elections.\n- **26th Amendment (1971):** Lowered the national voting age to **18**.\n\n## Your Rights at the Polls\n- **Secret Ballot:** No one can force you to reveal how you voted.\n- **The Line Rule:** If you are in line when the polls close, you legally must be allowed to cast your ballot.\n- **Provisional Ballot:** If your eligibility is questioned or your name isn't on the voter roll, you have the right to request a provisional ballot.\n- **Language Access:** In certain jurisdictions, voting materials must be provided in multiple languages.\n\n🆘 **Election Protection Hotline:** If you experience intimidation or issues, call **1-866-OUR-VOTE** (1-866-687-8683).`,
    },
  ],
};
